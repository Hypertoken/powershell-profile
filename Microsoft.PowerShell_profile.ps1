...
############                       https://github.com/Hypertoken/powershell-profile.git.                         ############
############                                                                                                         ############
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!#
############                                                                                                         ############
...
$canConnectToGitHub = Test-Connection github.com -Count 1 -Quiet -timeout 100
...
function Update-Profile {
    ...
    try {
        $url = "https://raw.githubusercontent.com/Hypertoken/powershell-profile/main/Microsoft.PowerShell_profile.ps1"
...
Write-Host -NoNewLine "Greetings, " -ForegroundColor White
Write-Host "$curUser!" -ForegroundColor Green
Write-Host -NoNewLine "It is: " -ForegroundColor White
Write-Host "$($time.ToLongDateString())" -ForegroundColor Blue
